...
imgContact.src= 'images/contact.png';
imgContact.style.width="100%";

document.body.prepend(section, section2);

let headingContact = document.createElement('h1');
headingContact.innerText = 'Контакты';


// let divTextContact = document.createElement('div');
// divTextContact.classList.add('divTextContact');

// let textContact = document.createElement('span');
// textContact.classList.add('textContact');
// divTextContact.append(textContact);

section2Content.append(imgContact,headingContact);
