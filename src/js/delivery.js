...
let section = document.querySelector('.container-fluid');
...
let imgDelivery = document.createElement('img');
imgDelivery.src= 'images/deliv.png';
imgDelivery.style.width="100%";

document.body.prepend(section, section2);

let headingDelivery = document.createElement('h1');
headingDelivery.innerText = 'Доставка';



let textDelivery = document.createElement('span');
textDelivery.classList.add('textDelivery');

section2Content.append(imgDelivery,headingDelivery, textDelivery);

textDelivery.innerText = 'Доставка товара по Минску и Минскому району производится 7 дней в неделю. Минимальная сумма заказа от 50р. При оформлении заказа до 13 часов, получение товара происходит в тот же день, в других случаях товар будет доставлен на следующий день. Дополнительную информацию можно получить у специалиста.';