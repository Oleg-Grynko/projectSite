...
let imgCooperation = document.createElement('img');
imgCooperation.src= 'images/cooperation.png';
imgCooperation.style.width="100%";

document.body.prepend(section, section2);

let headingCooperation = document.createElement('h1');
headingCooperation.innerText = 'Сотрудничество';



let textCooperation = document.createElement('span');
textCooperation.classList.add('textCooperation');

section2Content.append(imgCooperation,headingCooperation, textCooperation);

textCooperation.innerText = 'Компания Провиант Трейд приглашает к сотрудничеству юридических лиц и индивидуальных предпринимателей. Мы предлагаем выгодные условия для Вашего бизнеса!';